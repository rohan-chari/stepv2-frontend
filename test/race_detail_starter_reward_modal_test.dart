...
void main() {
  ...
  testWidgets('claiming swaps the same modal to the claimed state', (
    WidgetTester tester,
  ) async {
    ...
    // Still exactly one dialog — the reveal replaces the offer in place rather
    ...
    expect(find.text('Starter reward claimed.'), findsOneWidget);
