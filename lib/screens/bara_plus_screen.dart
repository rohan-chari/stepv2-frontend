...
class BaraPlusScreen extends StatefulWidget {
  final BillingController? controller;
  const BaraPlusScreen({super.key, this.controller});
  @override
  State<BaraPlusScreen> createState() => _BaraPlusScreenState();
}

class _BaraPlusScreenState extends State<BaraPlusScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (billing == null) {
      return Scaffold(
        ...
        appBar: AppBar(title: const Text('Bara+')),
        body: Center(child: _text('Membership is not available yet.')),
      );
    }
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 5),
                                    _text(
                                      cosmetic?.name ?? 'Something to show off',
                                      size: 18,
                                      title: true,
                                    ),
                                    const SizedBox(height: 4),
                ...
                if (!state.isPermanent) ...[
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (!state.isMember) const SizedBox(width: 10),
                      Expanded(
                        child: _planButton(
                  ...
                  Wrap(
                    ...
                    children: [
                      if (billing.termsUrl case final String url)
                        TextButton(
                          onPressed: () =>
                              _perform(() => billing.openLegal(url)),
