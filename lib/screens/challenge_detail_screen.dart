...
class _ChallengeDetailScreenState extends State<ChallengeDetailScreen> {
    ...
    return Column(
      children: [
        ...
        if (_stakesLoading)
          ...
          for (final stake in _stakes) _buildStakeItem(stake),
          const SizedBox(height: 16),
          if (_isSubmittingStake)
            ...
            PillButton(
              ...
              padding: const EdgeInsets.symmetric(
                  horizontal: 48, vertical: 16),
              onPressed:
                  _selectedStakeId != null ? _submitStakeSelection : null,
            ),
        ],
      ],
    );
  ...
  Widget _buildStakeItem(Map<String, dynamic> stake) {
        ...
        child: Row(
          children: [
            Icon(
              ...
              size: 20,
              color:
                  selected ? AppColors.pillGreen : AppColors.textMid,
            ),
